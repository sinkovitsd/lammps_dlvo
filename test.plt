...
GNUTERM = "wxt"
GPFUN_dlvo1 = "dlvo1(d,s,k)=0.5*d*s*s/(2*k*k*8.987556e6)"
GPFUN_dlvo2 = "dlvo2(d,h)=0.5*d*h/12.0"
GPFUN_dlvo3 = "dlvo3(d,h,m)=-dlvo2(d,h)*m**8/9.0"
GPFUN_oc = "oc(x,d,s,k)=dlvo1(d,s,k)*log(1+exp(-k*x))"
GPFUN_ov = "ov(x,d,h,m)=dlvo2(d,h)/x+dlvo3(d,h,m)/x**9"
GPFUN_energy = "energy(x,d,s,k,h,m,c,epsr) = (dlvo1(d,s,k)*log(1+exp(-k*x)) - oc(c,d,s,k))/epsr+(dlvo2(d,h)+dlvo3(d,h,m)/x**8)/x-ov(c,d,h,m)"
